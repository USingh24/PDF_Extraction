        ...
        for b_ind, box in enumerate(line):
            ...
            if 0 <= x1 < x2 < img.shape[1] and 0 <= y1 < y2 < img.shape[0]:
                if class_id == 1:
                    ...
                    dir_path = r"C:\Users\Brigosha_Guest\Desktop\streamlit_projects\Output_html\paper4"
...
if uploaded_file is not None:
    ...
    with fitz.open(temp_pdf_path) as doc:
        ...
        cfg.MODEL.WEIGHTS = "model_0002999 (1).pth"
        ...
        output_dir = r"C:\Users\Brigosha_Guest\Desktop\streamlit_projects\Output_html\paper4\page" + str(
            selected_page) + ".html"
        ...
        #generate_html(sorted_line_boxes, output_dir,img,im_np)
